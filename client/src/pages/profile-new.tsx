...
import { Save, Link as LinkIcon, Upload, Camera } from "lucide-react";
...
export default function Profile() {
  ...
  // Fetch snippets for combined graph
  ...
  // Combine question tags and snippet tags for graph
  const allTags = [
    ...questions.flatMap(q => q.tags || []),
    ...snippets.flatMap((s: any) => s.tags || [])
  ];
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-center text-muted-foreground py-12">
                  <p>No topic data yet. Start solving problems and adding tags!</p>
                </div>
              </CardContent>
            </Card>
          )}
